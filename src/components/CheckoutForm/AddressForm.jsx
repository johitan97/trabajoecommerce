      ...
      <FormProvider {...methods}>
        <form onSubmit={methods.handleSubmit((data) => test({ ...data, shippingCountry, shippingSubdivision, shippingOption }))}>
          <Grid container spacing={3}>
            ...
            <FormInput required name="address1" label="Direccion" />
            <FormInput required name="email" label="Correo" />
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>Divisiones</InputLabel>
            ...
            <Grid item xs={12} sm={6}>
              <InputLabel>Opciones de compra</InputLabel>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <Button component={Link} variant="outlined" to="/cart">Regresar al carro</Button>
